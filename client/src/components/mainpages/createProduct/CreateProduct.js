...
function CreateProduct() {
    ...
    const handleSubmit = async e =>{
        e.preventDefault()
        try {
            if(!isAdmin) return alert("Bạn không phải là adminn")
    ...
    return (
        <div className="create_product">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="row">
                    <label htmlFor="categories">Loại mặt hàng: </label>
                ...
                <button type="submit">{onEdit? "Chỉnh sửa" : "Tạo"}</button>
            </form>
        </div>
    )
}
